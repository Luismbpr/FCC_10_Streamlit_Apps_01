...
df = pd.read_csv('Projects/App_008_001/Data/penguins_cleaned.csv')

image_01 = Image.open(fp='Projects/App_008_001/Data/Images/penguins_01.jpeg', mode='r', formats=None)
...
penguins_raw = pd.read_csv('Projects/App_008_001/Data/penguins_cleaned.csv')
...
load_clf = pickle.load(open('Projects/App_008_001/Data/Saved_Models/model_02.pkl', 'rb'))
